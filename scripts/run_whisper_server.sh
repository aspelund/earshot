...
# Config file - override with CONFIG_PATH env var
export CONFIG_PATH="${CONFIG_PATH:-$PROJECT_DIR/config.yaml}"
...
echo "============================================================"
echo "STT Server (with diarization support)"
echo "============================================================"
echo "Config file: $CONFIG_PATH"
echo ""

# Use the venv python
"$PROJECT_DIR/.venv/bin/python" -m src.main_diarization_server
