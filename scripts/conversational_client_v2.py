#!/usr/bin/env python3
"""
Conversational Client v2 - Robust cancellation and interrupt handling.
...
# Import v2 components from src2
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from src2.audio import AudioPlayer
from src2.services import LLMClient, TTSClient

# Reuse VAD and Segmentor from original src (they don't need cancellation)
...
class ConversationalClient:
    """
    Conversational client v2 with robust interrupt handling.
...
def main():
    parser = argparse.ArgumentParser(
        description="Conversational client v2 with robust cancellation"
    )
    parser.add_argument(
        "--config",
        default="config.conversational_client_v2.yaml",
