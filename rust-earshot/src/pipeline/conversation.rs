...
use crate::clients::{ChatMessage, LlmClient, SttClient, TtsClient, TtsResult};
    ...
    let llm_tts_task = tokio::spawn(async move {
        loop {
            ...
            for sentence in sentences {
                ...
                // Send to TTS with retry on connection error
                let tts_result = {
